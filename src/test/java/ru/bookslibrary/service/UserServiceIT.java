...
class UserServiceIT {
    ...
    private static final String DEFAULT_FIO = "john";

    private static final String DEFAULT_ADDRESS = "moscow";
    ...
    /**
     * This repository is mocked in the ru.bookslibrary.repository.search test package.
     *
     * @see ru.bookslibrary.repository.search.UserSearchRepositoryMockConfiguration
     */
    @SpyBean
